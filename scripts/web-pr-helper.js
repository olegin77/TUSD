...
console.log('🌐 Cursor Web PR Helper');
...
try {
    ...
    console.log('⚠️  Branch might already exist, trying to push...');
    execSync(`git push`);
}
...
<body>
    <div class="container">
        ...
        <a href="${prUrl}" class="button" target="_blank">🔗 Create PR on GitHub</a>
        
        <h3>📋 Copy PR Description:</h3>
        <div class="code">
## 🚀 ${taskName}
...
console.log('\n📄 Created create-pr.html - open this file in your browser for easy PR creation!');