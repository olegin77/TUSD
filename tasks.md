...
- [ ] T-0001 | Инициализировать монорепо `usdx-wexel` с pnpm workspaces
    - depends: []
    - apply:
        ```bash
        set -euo pipefail
...
- [ ] T-0002 | Настроить TypeScript, ESLint, Prettier, Husky
    - depends: [T-0001]
    - apply:
        ```bash
...
- [ ] T-0003 | Настроить Docker Compose (Postgres, Redis)
    - depends: [T-0001]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
- [ ] T-0004 | Создать базовый CI workflow (lint, test, build) для `tusd`
    - depends: [T-0001]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
- [ ] T-0006 | Добавить базовую документацию: README.md, структура
    - depends: [T-0001]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
- [ ] T-0006.1 | Создать директорию для Architecture Decision Records (ADR)
    - depends: [T-0001]
    - apply:
        ```bash
        mkdir -p docs/adr
...
- [ ] T-0007 | Разработать визуальную концепцию и стиль платформы
    - depends: []
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
- [ ] T-0008 | Создать UI Kit в Figma (компоненты, состояния, адаптивность)
    - depends: [T-0007]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
- [ ] T-0009 | Разработать дизайн-макеты ключевых страниц в Figma (адаптивные)
    - depends: [T-0008]
    - apply:
        ```bash
...
*(Задачи T-0010 - T-0015 остаются как в предыдущем ответе)*
...
- [ ] T-0016 | Юнит-тесты для `deposit` и `apply_boost`
    - depends: [T-0013, T-0015]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
*(Задачи T-0030 - T-0032 остаются)*

- [ ] T-0033 | Реализовать UI Kit компоненты (все состояния, адаптивность) на основе Figma
...
- [ ] T-0034 | Создать базовую структуру страниц (Layout, Header) с UI Kit
...
- [ ] T-0035 | Настроить React Query или SWR
    - depends: [T-0030]
    - apply:
        ```bash
        # ... (код из предыдущего ответа) ...
...
*(Дальнейшие этапы 4-10 остаются, фронтенд задачи реализуются с учетом T-0033, T-0036, T-0037)*
