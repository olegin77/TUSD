...
module.exports = async function (deployer, network, accounts) {
  ...
  await vault.createPool(2, 2400, 24, 200 * 1e6);
  console.log("Created Pool 2: 24% APY, 24 months");

  // Pool 3: 30% APY, 36 months
  await vault.createPool(3, 3000, 36, 500 * 1e6);
  ...
  fs.writeFileSync(`deployed_addresses_${network}.json`, JSON.stringify(addresses, null, 2));
