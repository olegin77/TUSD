...
export type GetCollateralPositionAggregateType<T extends CollateralPositionAggregateArgs> = {
      [P in keyof T & keyof AggregateCollateralPosition]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
...
type GetCollateralPositionGroupByPayload<T extends CollateralPositionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CollateralPositionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CollateralPositionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type CollateralPositionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CollateralPositionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CollateralPositionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CollateralPosition'], meta: { name: 'CollateralPosition' } }
  /**
  ...
  count<T extends CollateralPositionCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CollateralPositionCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, CollateralPositionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCollateralPositionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
